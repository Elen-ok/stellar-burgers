...
- Location: tests\constructor.spec.ts:43:7
...
Call log:
  - waiting for locator('text=Краторная булка N-200i').first()
    - locator resolved to <p class="text text_type_main-default mZUnvup1IrMo87DtOf2Q">Краторная булка N-200i</p>
